            ...
            <div class="col-6 d-flex justify-content-end">
                <form class="form-inline d-none d-sm-inline-block">
                    <div class="input-group input-group-navbar">
                        <input name="search" type="text" class="form-control" placeholder="Tìm kiếm..." aria-label="Search" value="{{ request()->query('search') }}">
                ...
                <div class="card">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><img style="width: 100%;" src="{{ asset('assets/img/gallery/' . $product->product_image) }}" alt=""></td>
                                <td>{{ $product->product_id }}</td>
                                <td><a href="{{ asset('products/' . $product->product_id) }}">{{ $product->product_name }}</a>
                                </td>
                                ...
                                <td class="table-action">
                                    <div class="d-flex">
                                        <a href="{{ asset('be-admin/products/' . $product->product_id . '/edit') }}">
            ...
            <div class="col-12 d-flex justify-content-center">
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-end">
                        ...
                        @endphp
                        @for ($i = 0; $i < $countAllProduct / $perPage; $i++) <li class="page-item {{ $page == $i + 1 ? 'active' : '' }}">
